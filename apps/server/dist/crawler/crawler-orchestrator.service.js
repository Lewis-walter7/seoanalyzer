...
var CrawlerOrchestratorService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.CrawlerOrchestratorService = exports.CRAWLER_SERVICE_TOKEN = void 0;
const common_1 = require("@nestjs/common");
const event_emitter_1 = require("@nestjs/event-emitter");
const prisma_service_1 = require("../prisma/prisma.service");
const project_created_event_1 = require("../projects/events/project-created.event");
const seo_analyzer_util_1 = require("./utils/seo-analyzer.util");
// Injection token to avoid circular dependencies
exports.CRAWLER_SERVICE_TOKEN = 'CRAWLER_SERVICE_TOKEN';
let CrawlerOrchestratorService = CrawlerOrchestratorService_1 = class CrawlerOrchestratorService {
    prisma;
    eventEmitter;
    crawlerPlaywrightService;
    logger = new common_1.Logger(CrawlerOrchestratorService_1.name);
    seoAnalyzer;
    constructor(prisma, eventEmitter, crawlerPlaywrightService) {
        this.prisma = prisma;
        this.eventEmitter = eventEmitter;
        this.crawlerPlaywrightService = crawlerPlaywrightService;
     ...
     */
    async handleProjectAnalysisRequested(event) {
        try {
    ...
    async startCrawlAsync(crawlJobId, crawlJobDto, projectName) {
        try {
    ...
    async storePages(crawlJobId, pages) {
        try {
    ...
    async handleCrawlStarted(jobId) {
        try {
        ...
        try {
            ...
            if (page.html && page.html.trim()) {
                try {
                    ...
                    const performanceScore = this.seoAnalyzer.calculatePerformanceScore(page.size || updatedSeoAuditData.pageSize, page.loadTime);
    ...
    async handleCrawlProgress(progress) {
        try {
    ...
    async handleCrawlError(crawlError) {
        try {
    ...
    async handleCrawlFinished(result) {
        try {
    ...
    async storePagesFromResult(crawlJobId, pages) {
        try {
     ...
     */
    async updateProjectDetailsAfterCrawl(projectId, finalStatus) {
        try {
     ...
     */
    extractDomainVariations(rootUrl) {
        try {
...
exports.CrawlerOrchestratorService = CrawlerOrchestratorService;
__decorate([
...
], CrawlerOrchestratorService.prototype, "handleProjectCreated", null);
exports.CrawlerOrchestratorService = CrawlerOrchestratorService = CrawlerOrchestratorService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(2, (0, common_1.Inject)(exports.CRAWLER_SERVICE_TOKEN)),
